...
__global__ static void fused_attention_softmax_kernel(float* scores, size_t seq_len) {
...
extern "C" void vspec_cuda_attention_fused_single_f32(
    ...
    fused_attention_softmax_kernel<<<1, block>>>(d_scores, seq_len);
